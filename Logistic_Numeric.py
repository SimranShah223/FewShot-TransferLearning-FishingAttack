...
df_cat = pd.read_csv('Numeric_engineered_dataset.csv')

# Define features and target
X_numeric = df_cat.drop('Phishing attack', axis=1)
y_numeric = df_cat['Phishing attack']

# Split the data into training and test sets
X_train_num, X_test_num, y_train_num, y_test_num = train_test_split(X_numeric, y_numeric, test_size=0.2,
                                                                    random_state=42)
